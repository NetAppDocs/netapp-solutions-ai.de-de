...
NetApp instaclustr unterstützt Kafka ab Version 3.8.1 auch mit Tiered Storage. Weitere Details finden Sie hier. link:https://www.instaclustr.com/support/documentation/kafka-add-ons/using-kafka-tiered-storage/["Instaclust nutzt Kafka-Tiered Storage"]
