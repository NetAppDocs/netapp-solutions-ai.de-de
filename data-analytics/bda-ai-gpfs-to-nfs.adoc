...
summary: Dieser Abschnitt enthält die detaillierten Schritte zum Konfigurieren von GPFS und zum Verschieben von Daten in NFS mithilfe von NetApp XCP. 
---
...
[role="lead"]
Dieser Abschnitt enthält die detaillierten Schritte zum Konfigurieren von GPFS und zum Verschieben von Daten in NFS mithilfe von NetApp XCP.



== GPFS konfigurieren

. Laden Sie Spectrum Scale Data Access für Linux herunter und installieren Sie es auf einem der Server.
+
....
...
…
....
. Installieren Sie das erforderliche Paket (einschließlich Chef und Kernel-Header) auf allen Knoten.
+
....
...
....
. Deaktivieren Sie SELinux auf allen Knoten.
+
....
...
[root@mastr-51 5.0.3.1]#
....
. Richten Sie den Installationsknoten ein.
+
....
...
[root@mastr-51 installer]#
....
. Fügen Sie den Admin-Knoten und den GPFS-Knoten zur Clusterdefinitionsdatei hinzu.
+
....
...
[root@mastr-51 installer]#
....
. Fügen Sie den Managerknoten und den GPFS-Knoten hinzu.
+
....
...
[root@mastr-51 installer]#
....
. Fügen Sie den Quorum-Knoten und den GPFS-Knoten hinzu.
+
....
...
[root@mastr-51 installer]#
....
. Fügen Sie die NSD-Server und den GPFS-Knoten hinzu.
+
....
...
[root@mastr-51 installer]#
....
. Fügen Sie die GUI-, Admin- und GPFS-Knoten hinzu.
+
....
...
[root@mastr-51 installer]#
....
. Fügen Sie einen weiteren GUI-Server hinzu.
+
....
...
[root@mastr-51 installer]#
....
. Fügen Sie einen weiteren GPFS-Knoten hinzu.
+
....
...
[root@mastr-51 installer]#
....
. Überprüfen und listen Sie alle Knoten auf.
+
....
...
[root@mastr-51 installer]#
....
. Geben Sie in der Clusterdefinitionsdatei einen Clusternamen an.
+
....
...
....
. Geben Sie die Remote-Shell-Binärdatei an, die von GPFS verwendet werden soll. `-r argument` .
+
....
...
[root@mastr-51 installer]#
....
. Geben Sie die Binärdatei für die Remote-Dateikopie an, die von GPFS verwendet werden soll. `-rc argument` .
+
....
...
[root@mastr-51 installer]#
....
. Geben Sie den Portbereich an, der auf allen GPFS-Knoten festgelegt werden soll. Verwenden Sie `-e argument` .
+
....
...
[root@mastr-51 installer]#
....
. Zeigen Sie die GPFS-Konfigurationseinstellungen an.
+
....
...
[root@mastr-51 installer]#
....
. Fügen Sie einen Admin-Knoten hinzu.
+
....
...
[root@mastr-51 installer]#
....
. Überprüfen Sie die Konfigurationen vor der Installation.
+
....
...
[root@mastr-51 installer]#
....
. Konfigurieren Sie die NSD-Festplatten.
+
....
...
failureGroup=1
....
. Erstellen Sie die NSD-Datenträger.
+
....
...
....
. Überprüfen Sie den NSD-Festplattenstatus.
+
....
...
[root@mastr-51 cluster-test]#
....
. Überprüfen Sie die erforderlichen Berechtigungen und erteilen Sie sie dem GPFS.
+
....
...
[root@mastr-51 cluster-test]#
....
. Überprüfen Sie die GPFS-Lese- und Schreibvorgänge, indem Sie Folgendes ausführen: `dd` Befehl.
+
....
...
[root@mastr-51 ~]#
....
. Listen Sie die Dateien in GPFS auf, um den NFS-Client zu validieren.
+
....
...
. Installieren Sie Pakete im NFS-Client.
+
....
